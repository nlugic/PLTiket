...
public class DWNaiveBayes {
    ...
    public static void main(String[] args) {
        ...
        try
        {
            ...
            Logger.getLogger(DWNaiveBayes.class.getName()).log(Level.INFO, "Accuracy is " + accuracy);

            // Save model to local for future use
            model.save(jsc, "C:\\Users\\nlugic\\Desktop\\rad\\PLTiket\\LOCALP2\\modelExamples");
        }
        catch(Exception ex)
        {
            Logger.getLogger(DWNaiveBayes.class.getName()).log(Level.INFO, null, ex);
        }
